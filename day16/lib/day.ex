defmodule Day16b do
  ...
  def task_a(t) do
    ...
    {max, map, path} = dynamic(start, t, valves, [], 0, map, Map.new(), [])
    {max, map, Enum.reverse(path)}
  end
  ...
  ##
  def search(valve, 0, _valves, _open, _rate, _map, mem, path) do
    {0, mem, path}
  end
  ...
  def sample() do
    ...
    "Valve DD has flow rate=20; tunnels lead to valves CC, BB"]
  end
